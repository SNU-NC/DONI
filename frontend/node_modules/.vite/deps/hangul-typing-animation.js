...
// node_modules/hangul-typing-animation/esm/typeStream.js
var CHOSUNG_LIST = [
  "ㄱ",
  "ㄲ",
  "ㄴ",
...
function decomposeHangul(text) {
  ...
  for (var i = 0; i < text.length; i++) {
    ...
    decomposed.push([chosung, jungsung, jongsung].filter(function(jaso) {
      return jaso;
    }));
  }
  return decomposed;
...
var typeStream_default = createTypeStream;
export {
  composeHangul,
  typeStream_default as createTypeStream,
  decomposeHangul,
  delay,
  isDot,
  isInJongSung,
...
//# sourceMappingURL=hangul-typing-animation.js.map
